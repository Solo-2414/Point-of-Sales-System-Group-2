...
public class addProductPanel extends JPanel {
	...
	public addProductPanel() {
		...
		JLabel lbladdProduct = new JLabel("ADD NEW PRODUCT");
		...
		productID.setBackground(new Color(238, 238, 238));
		...
		proID.setText("The ID is generated automatically!");
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
		            ...
		            if (dao.addProduct(p)) {
		                ...
		                JFrame parent = (JFrame) SwingUtilities.getWindowAncestor(addProductPanel.this);
