...
public class editAccountPanel extends JPanel {
	...
	private int userId;
	public JTextField accID;
	public JTextField accName;
	public JTextField Password;
	public JComboBox power;

	/**
	 * Create the panel.
	 */
	public editAccountPanel(int userId) {
		this.userId = userId;
...
//        		
				try {
		            ...
		            if (dao.updateUser(u)) {
		                ...
		                JFrame parent = (JFrame) SwingUtilities.getWindowAncestor(editAccountPanel.this);
	...
	private void loadUserData() {
	    ...
	    if (u != null) {
	    	accID.setText(String.valueOf(u.getId()));
	    	accName.setText(u.getUsername());
	    	Password.setText(u.getPassword());
	    	power.setSelectedItem(u.getRole());
	    }
	}
