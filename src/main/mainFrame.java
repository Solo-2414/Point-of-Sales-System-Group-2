...
public class mainFrame extends JFrame {
	...
	public mainFrame(String username) {
		...
		roundPanel mainPanel = new roundPanel(30);      
		mainPanel.setBounds(255, 69, 1009, 612);
		mainPanel.setRoundType(roundPanel.RoundType.FULL);
		...
		dashPanel.setBorder(new LineBorder(new Color(58, 111, 67)));
		mainPanel.add(dashPanel, "dashboard");

		productPanel proPanel = new productPanel();
		proPanel.setBorder(new LineBorder(new Color(58, 111, 67)));
		mainPanel.add(proPanel, "product");

		reportPanel repPanel = new reportPanel();
		repPanel.setBorder(new LineBorder(new Color(58, 111, 67)));
		mainPanel.add(repPanel, "report");
		
		staffaccPanel adminPanel = new staffaccPanel();
		adminPanel.setBorder(new LineBorder(new Color(58, 111, 67)));
...
//This is the header ------------------------------------------------------------------------------------
		...
		btnNotif.setBounds(1104, 11, 78, 40);
...
//This is the sidebar------------------------------------------------------------------------------------------------
		...
		btnDashboard.setBounds(10, 221, 213, 34);
		...
		btnProductRec.setBounds(10, 272, 213, 40);
		...
		btnReports.setBounds(10, 328, 213, 34);
		...
		btnStaffAcc.setBounds(10, 377, 213, 40);
